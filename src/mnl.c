...
static int load_conf(const char *conf)
{
  ...
  if(lua_isstring(L, -1)) {
    mnl_strlcpy(vars.token, lua_tostring(L, -1), sizeof(vars.token));
  }
  lua_pop(L, 1);
...
int main()
{
  ...
  // 用户修改资料 USRE
  evhtp_set_cb(htp, "/usre", mnl_cbs_usre_post, NULL);

  // 用户邦卡 USRB
  evhtp_set_cb(htp, "/usrb", mnl_cbs_usrb_post, NULL);

  // 公户查询 UBQY
  evhtp_set_cb(htp, "/ubqy", mnl_cbs_ubqy_post, NULL);

  // 用户解邦卡 USRJ
  evhtp_set_cb(htp, "/usrj", mnl_cbs_usrj_post, NULL);

  // 用户关户 USRD
  evhtp_set_cb(htp, "/usrd", mnl_cbs_usrd_post, NULL);

  evhtp_set_cb(htp, "/chrg", mnl_cbs_chrg_post, NULL);
  evhtp_set_cb(htp, "/schg", mnl_cbs_schg_post, NULL);
  evhtp_set_cb(htp, "/wtdr", mnl_cbs_wtdr_post, NULL);
  evhtp_set_cb(htp, "/wdqy", mnl_cbs_wdqy_post, NULL);
  evhtp_set_cb(htp, "/mchg", mnl_cbs_mchg_post, NULL);
  evhtp_set_cb(htp, "/mdrw", mnl_cbs_mdrw_post, NULL);
  evhtp_set_cb(htp, "/proa", mnl_cbs_proa_post, NULL);
  evhtp_set_cb(htp, "/proc", mnl_cbs_proc_post, NULL);
  evhtp_set_cb(htp, "/froz", mnl_cbs_froz_post, NULL);
  evhtp_set_cb(htp, "/unfr", mnl_cbs_unfr_post, NULL);
  evhtp_set_cb(htp, "/invs", mnl_cbs_invs_post, NULL);
  evhtp_set_cb(htp, "/repy", mnl_cbs_repy_post, NULL);
  evhtp_set_cb(htp, "/casm", mnl_cbs_casm_post, NULL);
  evhtp_set_cb(htp, "/mfee", mnl_cbs_mfee_post, NULL);
  evhtp_set_cb(htp, "/mpay", mnl_cbs_mpay_post, NULL);
  evhtp_set_cb(htp, "/madv", mnl_cbs_madv_post, NULL);
  evhtp_set_cb(htp, "/mreg", mnl_cbs_mreg_post, NULL);
  evhtp_set_cb(htp, "/etpm", mnl_cbs_etpm_post, NULL);
  evhtp_set_cb(htp, "/oadv", mnl_cbs_oadv_post, NULL);
  evhtp_set_cb(htp, "/oreg", mnl_cbs_oreg_post, NULL);
  evhtp_set_cb(htp, "/scck", mnl_cbs_scck_post, NULL);
  evhtp_set_cb(htp, "/dcck", mnl_cbs_dcck_post, NULL);
  evhtp_set_cb(htp, "/bcck", mnl_cbs_bcck_post, NULL);
  evhtp_set_cb(htp, "/trqy", mnl_cbs_trqy_post, NULL);
  evhtp_set_cb(htp, "/rcqy", mnl_cbs_rcqy_post, NULL);
  evhtp_set_cb(htp, "/baqy", mnl_cbs_baqy_post, NULL);
  evhtp_set_cb(htp, "/file", mnl_cbs_file_post, NULL);
